...
<div class="page-container">
    ...
    <div class="page bg-cirques">
        ...
        <!-- bloc-2 -->
        <div class="bloc l-bloc pbloc-all bg-iphone" id="bloc-2">
            <div class="container bloc-lg pbloc-btn">
                ...
                <div class="cadre_btn">
                    ...
                    <input id="fermer" class="btn-wire btn btn-xl wire-btn-red-pigment animated fadeIn animDelay02" type="submit" name="fermer" value="Fermer le portail">
                    </form>      
                </div>
                <div id="sign_div">
                    <p class="ft-white">
